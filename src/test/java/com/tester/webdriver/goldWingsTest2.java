...
public class goldWingsTest2 {
    ...
    public static void main(String[] args) {
        ...
        driver.findElement(By.xpath("//*[@id='audioPublicationName']")).sendKeys("Random publication.");
        driver.findElement(By.xpath("//*[@id='audioPublicationURL']")).sendKeys("www.randompublicationtest.net");
        driver.findElement(By.xpath("//*[@id='audioPassword']")).sendKeys("123456789");
